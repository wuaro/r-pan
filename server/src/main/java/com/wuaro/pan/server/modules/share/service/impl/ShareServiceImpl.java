...
//import com.wuaro.pan.bloom.filter.core.BloomFilter;
//import com.wuaro.pan.bloom.filter.core.BloomFilterManager;
...
import com.wuaro.pan.server.common.cache.ManualCacheService;
...
import com.wuaro.pan.server.modules.file.context.CopyFileContext;
import com.wuaro.pan.server.modules.file.context.FileDownloadContext;
...
import com.wuaro.pan.server.modules.share.constants.ShareConstants;
import com.wuaro.pan.server.modules.share.context.*;
import com.wuaro.pan.server.modules.share.entity.RPanShare;
import com.wuaro.pan.server.modules.share.enums.ShareDayTypeEnum;
import com.wuaro.pan.server.modules.share.enums.ShareStatusEnum;
import com.wuaro.pan.server.modules.share.mapper.RPanShareMapper;
import com.wuaro.pan.server.modules.share.service.IShareFileService;
import com.wuaro.pan.server.modules.share.service.IShareService;
import com.wuaro.pan.server.modules.share.vo.*;
...
//    }
    ...
    private void doChangeShareStatus(Long shareId, ShareStatusEnum shareStatus) {
        ...
        if(!update(updateWrapper)){
            applicationContext.publishEvent(new ErrorLogEvent(this,"更新分享失败，请手动更改状态，分享ID为："+shareId+",分享"+
                    "状态改为："+shareStatus.getCode(),RPanConstants.ZERO_LONG));
        }
    }
...
//        Bloom,Filter<Long> bloomFilter = manager.getFilter(BLOOM_FILTER_NAME);
